          ...
          <div class="panel-body">
              ...
              <!-- Inicio / Medico  -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <label>Abona a Falta?</label>
                    <select id="accredit" name="accredit" class="form-control selectpicker" data-live-search="true" required>
                       <option value=""> Selecione </option>
                      <option value="1"<?php echo $result->mcaccredit==1?' selected':''; ?>> Sim </option>
                      <option value="0"<?php echo $result->mcaccredit==0?' selected':''; ?>> Não </option>
                    </select>
                  </div>
