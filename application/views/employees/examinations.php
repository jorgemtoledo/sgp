<div id="page-wrapper">
  <div class="row">
      <h1 class="page-header">Controle Exame Periódicos</h1>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>Exame Periódico</div>
                    </div>
                </div>
            </div>
            <a href="<?php echo base_url(); ?>employees/examinationlists">
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div> Periódicos - <?php echo $year= date('Y'); ?></div>
                    </div>
                </div>
            </div>
