<div id="page-wrapper">
  <div class="row">
          ...
          <div class="row">
            <div class="col-sm-12">
                <h3>Dados</h3>
                <form class="form-group" action="<?php echo base_url() ?>employees/saveChecked" method="post">
                <input type="hidden" class="form-control" name="id" value="<?php echo $result->eid; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="employee_id" value="<?php echo $result->empid; ?>">
                    </div>
                    </div>
                    <div class="col-sm-5">
                    <div class="form-group">
                    ...
                    <div class="form-group has-success">
                      <label class="control-label" for="examination_scheduled" for="inputSuccess">Data Agendada:</label>
                        ...
                        <input type="hidden" class="form-control" name="examination_scheduled" value="<?php   $escheduled = strtotime(($result->escheduled));echo date('Y-m-d', $escheduled);?>">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="description">Observações</label>
                          <div>
                              ...
                              <input type="hidden" class="form-control" name="description" value="<?php echo $result->edescription; ?>">
                          </div>
                      </div>
                    </div>
                    </div>
