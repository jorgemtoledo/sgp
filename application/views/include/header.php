...
<head>
   ...
   <link href="<?php echo base_url('assets/bootstrap-3.1.1/css/multiple-select.css') ?>" rel="stylesheet">
   <link href="<?php echo base_url('assets/bootstrap-3.1.1/css/bootstrap-select.min.css') ?>" rel="stylesheet">
   <link href="<?php echo base_url('assets/bootstrap-3.1.1/css/bootstrap-multiselect.css') ?>" rel="stylesheet">
   <link href="<?php echo base_url('assets/bootstrap-3.1.1/css/dataTables.bootstrap.css') ?>" rel="stylesheet">



   <link href="<?php echo base_url('assets/bootstrap-3.1.1/css/jquery-ui.css') ?>" rel="stylesheet">
   ...
   <link href="<?php echo base_url('assets/sb-admin-v2/css/datepicker.css') ?>" rel="stylesheet">
