<div id="page-wrapper">
    <div class="row">
        <h3 class="page-header">Editar ou Concluir 1° Periodo de Experiência</h3>

                            <div class="box-header">
                                <!-- Botao voltar -->
                                <a href="<?php echo base_url('experiences/editExpOne'); ?>"  class="btn btn-primary">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="home">
                                                        ...
                                                        <form class="form-group" action="<?php echo base_url() ?>experiences/saveEditexperienceOne" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="sale1"  name="sale1" value="<?php echo $empExperiences->esale1; ?>" min="0" required>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="sale2"  value="<?php echo $empExperiences->esale2; ?>" name="sale2"  min="0" required>
                                                            </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_sales1" name="description_sales1"  rows="5" required><?php echo $empExperiences->edescriptionsales1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_behavioral1" name="description_behavioral1"  rows="10" required><?php echo $empExperiences->edescriptionbehavioral1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_attendance1" name="description_attendance1"  rows="10" required> <?php echo $empExperiences->edescriptionattendance1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="value_quality1"  name="value_quality1" value="<?php echo $empExperiences->evaluequality1; ?>">
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="value_quality2"  name="value_quality2" value="<?php echo $empExperiences->evaluequality2; ?>">
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="value_quality3"  name="value_quality3" value="<?php echo $empExperiences->evaluequality3; ?>">
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="average_quality1" name="average_quality1" value="<?php echo $empExperiences->eaveragequality1; ?>">
                                                            </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_quality1" name="description_quality1"  rows="10" required><?php echo $empExperiences->edescriptionquality1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_measure1" name="description_measure1"  rows="10" required><?php echo $empExperiences->edescriptionmeasure1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="sup_approved1" id="sup_approved1" value="1" <?= $empExperiences->esupapproved1 == "1" ? "checked=\"checked\"" : ""; ?>>APROVADO
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="sup_approved1" id="sup_approved1" value="0" <?= $empExperiences->esupapproved1 == "0" ? "checked=\"checked\"" : ""; ?>>REPROVADO
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="coordinator_id1" name="coordinator_id1" class="form-control" required>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_sup1" name="description_sup1"  rows="10" required><?php echo $empExperiences->edescriptionsup1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
