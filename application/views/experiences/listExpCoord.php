<div id="page-wrapper">
    <div class="row">
        <h3 class="page-header">Lista 1° Periodo de Experiência (Coordenador)</h3>
                        ...
                        <tr>
                              ...
                              <td class="text-center danger"><h6>
                                ...
                                <?php $trainne = $editexperience->jid;
                                    ...
                                    <a href="<?php echo base_url('experiences/editExperienceOneCoord/'.$editexperience->eid); ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-pencil"></i></a>
                                <?php } ?>
                                </h6></td>
                                <?php } else  {?>
                                ...
                                <?php $trainne = $editexperience->jid;
                                    ...
                                    <a href="<?php echo base_url('experiences/editExperienceOneCoord/'.$editexperience->eid); ?>" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-pencil"></i></a>
                                <?php } ?>
