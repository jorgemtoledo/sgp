    ...
    <div class="row">
        <h3 class="page-header">1° Periodo de Experiência</h3>
                            ...
                            <div class="box-header">
                                <!-- Botao voltar -->
                                <a href="<?php echo base_url('experiences/editExpOneRH'); ?>"  class="btn btn-primary">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="home">
                                                        ...
                                                        <form class="form-group" action="<?php echo base_url() ?>experiences/saveEditExpRHOne" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="coordinator_id1" id="coordinator_id1" value="1" <?= $empExperiences->ecoordapproved1 == "1" ? "checked=\"checked\"" : ""; ?> disabled>APROVADO
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="coordinator_id1" id="coordinator_id1" value="0" <?= $empExperiences->ecoordapproved1 == "0" ? "checked=\"checked\"" : ""; ?> disabled>REPROVADO
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_coord1" name="description_coord1"  rows="10" disabled><?php echo $empExperiences->edescriptioncoord1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="rh_approved1" id="rh_approved1" value="1" <?= $empExperiences->erhapproved1 == "1" ? "checked=\"checked\"" : ""; ?>>APROVADO
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="rh_approved1" id="rh_approved1" value="0" <?= $empExperiences->erhapproved1 == "0" ? "checked=\"checked\"" : ""; ?>>REPROVADO
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <select id="reason_experience_rh1" name="reason_experience_rh1" class="form-control">
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_rh1" name="description_rh1"  rows="10"><?php echo $empExperiences->edescriptionrh1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
