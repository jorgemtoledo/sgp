                        ...
                        <tr>
                              ...
                              <td class="text-center danger"><h6>
                                ...
                                <?php $trainne = $editexperience->jid;
                                    ...
                                    <a href="<?php echo base_url('experiences/editexperienceone/'.$editexperience->eid); ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-pencil"></i></a>
                                <?php } ?>
                                </h6></td>
                                <?php } else  {?>
                                ...
                                <?php $trainne = $editexperience->jid;
                                    ...
                                    <a href="<?php echo base_url('experiences/editexperienceone/'.$editexperience->eid); ?>" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-pencil"></i></a>
                                <?php } ?>
