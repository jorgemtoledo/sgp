<div id="page-wrapper">
    <div class="row">
        <h3 class="page-header"> 1° Periodo de Experiênciafsfssf</h3>

                            <div class="box-header">
                                <!-- Botao voltar -->
                                <a href="<?php echo base_url('experiences/listFinishOne'); ?>"  class="btn btn-primary">
                                                    ...
                                                    <div class="tab-pane fade in active" id="home">
                                                        ...
                                                        <form class="form-group" action="<?php echo base_url() ?>experiences/saveEditExpCoordOne" method="post">
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_behavioral1" name="description_behavioral1"  rows="5" disabled><?php echo $empExperiences->edescriptionbehavioral1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <h3 class="page-header ">Frequência</h3>
                                                            <div class="row">
                                                            <div class="col-sm-12">
                                                            <div class="form-group">
                                                              <label for="description">Dados de Frequencia</label>
                                                                  <div>
                                                                ...
                                                                <label for="description">Dados Atestados Médicos</label>
                                                                <div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_attendance1" name="description_attendance1"  rows="4" disabled> <?php echo $empExperiences->edescriptionattendance1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="value_quality1"  name="value_quality1" value="<?php echo $empExperiences->evaluequality1; ?>"  min="0" disabled>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="value_quality2"  name="value_quality2" value="<?php echo $empExperiences->evaluequality2; ?>" min="0" disabled>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="value_quality3"  name="value_quality3" value="<?php echo $empExperiences->evaluequality3; ?>"  min="0" disabled>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="average_quality1" name="average_quality1" value="<?php echo $empExperiences->eaveragequality1; ?>" min="0" disabled>
                                                            </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_quality1" name="description_quality1"  rows="5" disabled><?php echo $empExperiences->edescriptionquality1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>

                                                            <h3 class="page-header  text-warning">Medidas Disciplinares</h3>
                                                            <div class="row">
                                                            <div class="col-sm-8">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_measure1" name="description_measure1"  rows="4" disabled><?php echo $empExperiences->edescriptionmeasure1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="sup_approved1" id="sup_approved1" disabled value="1" <?= $empExperiences->esupapproved1 == "1" ? "checked=\"checked\"" : ""; ?>>APROVADO
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="sup_approved1" id="sup_approved1" disabled value="0" <?= $empExperiences->esupapproved1 == "0" ? "checked=\"checked\"" : ""; ?>>REPROVADO
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_sup1" name="description_sup1"  rows="4" disabled><?php echo $empExperiences->edescriptionsup1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="ecoordapproved1" id="ecoordapproved1" value="1" <?= $empExperiences->ecoordapproved1 == "1" ? "checked=\"checked\"" : ""; ?> disabled>APROVADO
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="ecoordapproved1" id="ecoordapproved1" value="0" <?= $empExperiences->ecoordapproved1 == "0" ? "checked=\"checked\"" : ""; ?> disabled>REPROVADO
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="edescriptioncoord1" name="edescriptioncoord1"  rows="4" disabled><?php echo $empExperiences->edescriptioncoord1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <h3 class="page-header  text-danger">Parecer RH</h3>
                                                            <div class="row">
                                                            <div class="col-sm-8">
                                                            <div class="form-group">
                                                                        <label>PARECER</label>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="rh_approved1" id="rh_approved1" value="1" <?= $empExperiences->erhapproved1 == "1" ? "checked=\"checked\"" : ""; ?> disabled>APROVADO
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="rh_approved1" id="rh_approved1" value="0" <?= $empExperiences->erhapproved1 == "0" ? "checked=\"checked\"" : ""; ?> disabled>REPROVADO
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <select id="reason_experience_rh1" name="reason_experience_rh1" class="form-control" disabled>
                                                                            <option value="<?php echo $empExperiences->ereassonrh1; ?>"> <?php echo $empExperiences->ereassonrh1; ?> </option>
                                                                            ...
                                                                            <option value="Motivo 6"> Motivo 6</option>
                                                                            <option value="Motivo 7"> Motivo 7</option>
                                                                          </select>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                              <label for="description">Comentários</label>
                                                                  <div>
                                                                      <textarea class="form-control" id="description_rh1" name="description_rh1"  rows="10" disabled><?php echo $empExperiences->edescriptionrh1; ?></textarea>
                                                                  </div>
                                                              </div>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="finish_pediod1" id="finish_pediod1" disabled value="1" <?= $empExperiences->efinishperiod1 == "1" ? "checked=\"checked\"" : ""; ?>>Sim
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio">
                                                                            <label>
                                                                                <input type="radio" name="finish_pediod1" id="finish_pediod1" disabled value="0" <?= $empExperiences->efinishperiod1 == "0" ? "checked=\"checked\"" : ""; ?>>Não
                                                                            </label>
                                                                        </div>
                                                              </div>
                                                            </div>
