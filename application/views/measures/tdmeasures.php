...
<div id="page-wrapper">
    <h1 class="page-header">Medidas Disciplinares da Equipe</h1>
    <!-- Botao voltar -->
     ...
     <div class="col-lg-11">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                 Medidas Disciplinares por mês - <?php  $yearmeasures = date("Y");
                                                            echo $yearmeasures;
                                                     ?> - EQUIPE:
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            ...
                                            <?php
                                                        ...
                                                        $this->db->where(1, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(2, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(3, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(4, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(5, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(6, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(7, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(8, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(9, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(10, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(11, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                                            ...
                                            <?php
                                                        $this->db->where('workers.team_id',$teamOne->tid);
                                                        $this->db->where(12, 'MONTH(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->where($yearmeasures, 'YEAR(disciplinary_measures.delivery_date)' , FALSE);
                                                        $this->db->from('disciplinary_measures');
                                                        $this->db->join('workers', 'workers.id = disciplinary_measures.worker_id');
                ...
                <div class="col-lg-11">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                                 Grafico Medidas do ano <?php  $yearmedicalcertificates = date("Y");
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('measures/dmeasureworker/'.$team->wid); ?>"><?php echo $team->ename;?></a></td>
                                            <?php
