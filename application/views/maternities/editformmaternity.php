  ...
  <div class="row">
       ...
       <div class="panel panel-default">
          ...
          <div class="panel-body">
              ...
              <form class="form-horizontal" role="form" action="<?php echo base_url() ?>maternities/saveEditFormMaternity" method="post">
              <input type="hidden" id="medical_certificate_id" name="medical_certificate_id" value="<?php echo $result->mcid; ?>">
              <input type="hidden" id="id" name="id" value="<?php echo $result->mtid; ?>">

                <div class="form-group">

                  <div class="col-md-8">
                    <label>Funcionário:</label><?php echo $result->mtid; ?> 
                ...
                <div class="form-group">
                  <div class="col-md-3">
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="finish_maternity" id="optionsRadios1" value="1" <?= $result->mtfinish == "1" ? "checked=\"checked\"" : ""; ?>>
                        SIM
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="finish_maternity" id="optionsRadios1" value="0" <?= $result->mtfinish == "0" ? "checked=\"checked\"" : ""; ?>>
                       NÃO
                      </label>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="description" name="description"  rows="4" required><?php echo $result->mtdescription; ?></textarea><br />
                  </div>
                </div><br>
